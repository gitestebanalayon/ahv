...
#     def editar(self, obj):
#         return format_html('<a class="btn" href="/admin/sistema/agregadopedido/{}/change/"><span class="material-symbols-outlined text-primary-600 dark:text-primary-600">edit</span></a>', obj.id)
#     def eliminar(self, obj):
#         return format_html('<a class="btn" href="/admin/sistema/agregadopedido/{}/delete/"><span class="material-symbols-outlined text-red-600 dark:text-red-600">delete</span></a>', obj.id)
