...
# /var/www/ahv_pythonanywhere_com_wsgi.py - VERSIÓN CORREGIDA
import os
import sys

# RUTA AL ENTORNO VIRTUAL
venv_path = '/home/ahv/ahv/.venv'
...
project_home = '/home/ahv/ahv'
if project_home not in sys.path:
    sys.path.insert(0, project_home)

# 4. Agregar la carpeta configuracion
configuracion_path = '/home/ahv/ahv/configuracion'
